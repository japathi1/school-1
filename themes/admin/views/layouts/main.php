...
<html>
  <head>
    ...
    <!-- Daterange picker -->
    <link rel="stylesheet" href="<?php echo $baseUrl;?>/plugins/daterangepicker/daterangepicker-bs3.css">
  ...
  <body class="hold-transition skin-blue sidebar-mini">
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="<?php echo base_url()."/admin/schools"; ?>"><i class="fa fa-university"></i> <span>Schools</span></a></li>
            <li><a href="<?php echo base_url()."/admin/schoolCharges"; ?>"><i class="fa fa-university"></i> <span>School Charges</span></a></li>
            <li>
              <a href="<?php echo base_url()."/admin/transactions"; ?>"><i class="fa fa-university"></i> <span>Transactions</span></a>
            </li>
            <li>
              <a href="<?php echo base_url()."/admin/states"; ?>"><i class="fa fa-university"></i> <span>States</span></a>
            </li>
          </ul>
        </section>
        <!-- /.sidebar -->
    ...
    <!-- datepicker -->
    <script src="<?php echo $baseUrl;?>/plugins/datepicker/bootstrap-datepicker.js"></script>
    <!-- Bootstrap WYSIHTML5 -->
