    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="<?php echo base_url().'/admin'; ?>" class="logo">
          ...
          <span class="logo-lg"><b><?php echo Yii::app()->user->getState('school'); ?></b></span>
        </a>
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    ...
                    <div class="pull-right">
                      <a href="<?php echo base_url().'/school/logout'; ?>" class="btn btn-default btn-flat">Sign out</a>
                    </div>
                  </li>
                </ul>
              </li>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="<?php echo base_url()."/school/feestructure"; ?>"><i class="fa fa-university"></i> <span>Fee Structure</span></a></li>
            <li>
