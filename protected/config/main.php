    ...
    'components' => array(
        ...
        'urlManager' => array(
            ...
            'rules' => array(
                ...
                '<module:(school)>/<controller:\w+>/<action:\w+>/<id:(.*?)>' => '<module>/<controller>/<action>/<id>',
                '<module:(school)>/<controller:\w+>/<action:\w+>' => '<module>/<controller>/<action>',
                '<module:(school)>/<controller:\w+>' => '<module>/<controller>',
