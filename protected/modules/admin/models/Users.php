...
class Users extends AdminBaseModel
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, username, password, verifyPassword, role, school_id, firstname, lastname, email, mobile, status, deleted, date_entered, date_modified, created_by, modified_by', 'safe', 'on'=>'search'),
		);
	}
