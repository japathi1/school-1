...
<div class="box-body">
	<div class="form-group">
		<div class="col-xs-4">
			...
			<?php echo $form->textField($model,'class_id',array('size'=>60,'maxlength'=>255,'class' => 'form-control')); ?>
			<?php echo $form->error($model,'class_id'); ?>
		</div>
		<div class="col-xs-4">
			<?php echo $form->labelEx($model,'fee_label_id'); ?>
			<?php echo $form->textField($model,'fee_label_id',array('size'=>60,'maxlength'=>255,'class' => 'form-control')); ?>
