<section class="content-header">
    <h1>
        Manage
        <small>Fee Labels</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url() . '/school'; ?>"><i class="fa fa-dashboard"></i> Dashboard</a></li>
        <li><a href="<?php echo base_url() . '/school/feelabel'; ?>"><i class="fa fa-dashboard"></i> Fee Label</a></li>
        ...
        <div class="col-xs-12">
            ...
            <div class="box">
                <div class="box-header">
                    <div class="row">
                        <div class="col-sm-8">
                            <h3 class="box-title">Fee label List</h3>
                        </div>
                        <div class="col-sm-4">
                            <a href="<?php echo base_url() . '/school/feelabel/create'; ?>">
                                <button class="btn btn-block btn-primary">Add Fee Label</button>
                            </a>
                        </div>
                    </div>
                </div>
                                        ...
                                        array(
                                            ...
                                            'buttons' => array(
                                                'v'=>array(
                                                        ...
                                                        'url'=>'Yii::app()->createUrl("school/feelabel/view", array("id"=>$data->id))',
                                                ...
                                                'u'=>array(
                                                        ...
                                                        'url'=>'Yii::app()->createUrl("school/feelabel/update", array("id"=>$data->id))',
                                                ...
                                                'd'=>array(
                                                        ...
                                                        'url'=>'Yii::app()->createUrl("school/feelabel/delete", array("id"=>$data->id))',
