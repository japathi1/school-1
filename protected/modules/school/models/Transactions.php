...
class Transactions extends BaseModel
{
	...
	public function rules()
	{
		...
		return array(
			array('id, school, student, class, section, receipt, transaction_type, amount, amount_detail, month, year, payment_status, created_by, modified_by, date_entered, date_modified', 'required'),
	...
	public function search()
	{
		...
		$criteria->compare('amount_detail',$this->amount_detail,true);
